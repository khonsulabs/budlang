...
The virtual machine invokes `Environment::step()` before each instruction is
exected. The environment can return `ExecutionBehavior::Pause` to pause
execution, and the state of the virtual machine will be saved such that it can
be resumed again.
...
[fib-ex]: https://github.com/khonsulabs/bud/blob/main/examples/fib.rs
[fib-vm]: https://github.com/khonsulabs/bud/blob/main/examples/fib-vm.rs
